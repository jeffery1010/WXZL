...
namespace ERPWeb.Business
{
    ...
    public class BaseBusiness<T> : IRepository<T> where T : class, new()
    {
        ...
        public List<U> GetListByProc<U>(string procName, List<DbParameter> parameters) where U: class, IModelDecorator<U>,new()
        {
            return Service.GetListByProc<U>(procName, parameters);
        }
        public AjaxResult SubmitDataByProc<U>(string procName, List<DbParameter> parameters) where U : class, IModelDecorator<U>, new()
        {
            return Service.SubmitDataByProc<U>(procName, parameters);
        }
        #endregion
        ...
        public DataSet ExecuteProcedureForDataSet(string proc, List<DbParameter> parameters)
        {
           return Service.ExecuteProcedureForDataSet(proc, parameters); 
        }
        public DataTable ExecuteProcedureForDataTable(string proc, List<DbParameter> parameters)
        {
            return Service.ExecuteProcedureForDataTable(proc, parameters);
        }
        #endregion
        ...
        {
            Util.AjaxResult res = new Util.AjaxResult
            {
                Success = true,
                Msg = "请求成功！",
                Data = null
