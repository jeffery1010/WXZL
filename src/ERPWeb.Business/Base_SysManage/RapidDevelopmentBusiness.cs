...
{
    public class RapidDevelopmentBusiness : BaseBusiness<DatabaseLink>
    {
        #region 外部接口
        ...
        /// </summary>
        /// <returns></returns>
        public List<DatabaseLink> GetAllDbLink()
        {
            return GetList();
        }
        ...
        private void BuildEntity(List<TableInfo> tableInfo, string areaName, string tableName)
        {
            ...
            string entityPath = rootPath.Replace("ERPWeb.Web", "ERPWeb.Entity") + areaName;
            string filePath = $@"{entityPath}\{tableName}.cs";
            string nameSpace = $@"ERPWeb.Entity.{areaName}";
...
namespace ERPWeb.Business.{areaName}
{{
    ...
    {{
        ...
        #region 数据模型
            ...
            string rootPath = AppDomain.CurrentDomain.BaseDirectory;
            string areaPath = rootPath.Replace("ERPWeb.Web", "ERPWeb.Business") + areaName;
        ...
        private void BuildController(string areaName, string entityName)
        {
            ...
            string code =
$@"using ERPWeb.Business.{areaName};
using ERPWeb.Entity.{areaName};
using ERPWeb.Util;
using System;
  ...
  <system.webServer>
    <handlers>
      ...
      <add name=""BlockViewHandler"" path=""*"" verb=""*"" preCondition=""integratedMode"" type=""System.Web.HttpNotFoundHandler"" />
        ...
        /// <param name="linkId">连接Id</param>
        /// <returns></returns>
        private DatabaseLink GetTheLink(string linkId)
        {
            DatabaseLink resObj = new DatabaseLink();
