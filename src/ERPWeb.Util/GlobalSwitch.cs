...
namespace ERPWeb.Util
{
    ...
    public static class GlobalSwitch
    {
        ...
        /// 项目名
        /// </summary>
        public static string ProjectName { get; } = "ERPWeb";
        ...
        /// 默认数据库连接名
        /// </summary>
        public static string DefaultDbConName { get; } = "WXZL";

        /// <summary>
        /// 默认实体命名空间
        /// </summary>
        public static string DefaultEntityNamespace { get; } = "ERPWeb.Entity";
