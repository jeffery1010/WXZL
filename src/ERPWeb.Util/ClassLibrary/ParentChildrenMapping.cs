...
namespace ERPWeb.Util
{
    ...
    public class ParentChildrenMapping
    {
        ...
        private ConcurrentDictionary<string, SynchronizedCollection<string>> _pToC { get; } = new ConcurrentDictionary<string, SynchronizedCollection<string>>();
        ...
        public void AddChild(string parentId, string childId)
        {
            ...
            SynchronizedCollection<string> children = null;
            if (!_pToC.ContainsKey(parentId))
            {
                children = new SynchronizedCollection<string>();
        ...
        public void RemoveParent(string parentId)
        {
            ...
            _pToC.TryRemove(parentId, out SynchronizedCollection<string> children);
            if (children != null)
            {
