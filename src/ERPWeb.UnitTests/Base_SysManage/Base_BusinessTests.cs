...
namespace ERPWeb.UnitTests
{
    ...
    public class Base_BusinessTests
    {
        ...
        public void UpdateTest()
        {
            ...
            newUpdateData.UserNo = "普通管理员";
            newUpdateData.UserId = "xiaoming";
            newUpdateData.Age = 100;
            _baseBus.UpdateAny(newUpdateData, new List<string> { "UserNo", "Age" });
            ...
            _baseBus.UpdateAny(newList1, new List<string> { "UserNo", "Age" });
        ...
        public void ExcuteSqlTest()
        {
            ...
            _baseBus.DeleteAll();
            _baseBus.Insert(_newData);
            sql = "delete from Base_UnitTest where UserNo like '%'+@name+'%'";
        ...
        public void TransactionTest()
        {
            ...
            newData.UserNo = Guid.NewGuid().ToSequentialGuid();
            _baseBus.Insert(_newData);
