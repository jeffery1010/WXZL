...
namespace ERPWeb.DataRepository
{
    public interface IRepository
    {
        ...
        List<T> GetListByProc<T>(string procName, List<DbParameter> parameters) where T : class, IModelDecorator<T>, new();
        AjaxResult SubmitDataByProc<T>(string procName, List<DbParameter> parameters) where T : class, IModelDecorator<T>, new();
        ...
        DataTable ExecuteProcedureForDataTable(string proc, List<DbParameter> parameters);
        DataSet ExecuteProcedureForDataSet(string proc, List<DbParameter> parameters);
        #endregion
    }
}
